 ...
 *
 * Disassembly of DSDT.aml, Wed Apr  1 21:57:27 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000CA0E (51726)
 *     Revision         0x02
 *     Checksum         0x0F
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000088)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDD784C18, 0x02B2)
...
{If (LLessEqual (Arg0, 0x5E))
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDD685E18, 0x10)
            ...
            If (TCMF)
{
    ...
    Scope (_SB)
    {
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0xDD770018, 0x00FC)
            ...
            {
                OperationRegion (GDAD, SystemMemory, 0xDD76E018, 0x0178)
